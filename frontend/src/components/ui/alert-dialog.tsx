...
function AlertDialogHeader({
    ...
    return (
        <div
            ...
            className={cn(
                'flex flex-col gap-2 text-center sm:text-left dark:text-black',
                className
            )}
            {...props}
        />
