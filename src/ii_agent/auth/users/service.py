...
class UserService:
    ...
    async def get_user_by_id(self, db: AsyncSession, user_id: str) -> Optional[User]:
        ...
        return await self._user_repo.get_by_id(db, user_id)

    async def get_user_by_email(self, db: AsyncSession, email: str) -> Optional[User]:
        """Get a user by their email."""
        return await self._user_repo.get_by_email(db, email)

    async def get_active_api_key(self, db: AsyncSession, user_id: str) -> Optional[str]:
    ...
    async def create_api_key(self, db: AsyncSession, *, user_id: str) -> APIKey:
        ...
        from ii_agent.auth.api_key_utils import generate_prefixed_api_key
