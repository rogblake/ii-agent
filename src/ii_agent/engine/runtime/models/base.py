...
from ii_agent.engine.runtime.models.message import Citations, Message
...
from ii_agent.engine.runtime.tools.function import (
    Function,
    FunctionCall,
    ...
    async def arun_function_calls(
        ...
        for i, original_result in enumerate(results):
            ...
            if async_function_call_output is not None:
                ...
                from ii_agent.engine.runtime.tools.function import ToolResult as FunctionToolResult
                from ii_agent.engine.runtime.tools.base import ToolResult as BaseToolResult
