...
from ii_agent.engine.runtime.media import Audio, Image
...
from ii_agent.engine.runtime.agent_sessions.summary import SessionSummary
...
async def _persist_event_to_db(
    ...
    """
    try:
        from ii_agent.engine.runtime.db.agent import AgentEvent
