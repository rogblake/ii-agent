...
from ii_agent.engine.runtime.tools.function import Function, get_entrypoint_docstring
...
def tool(*args, **kwargs) -> Union[Function, Callable[[F], Function]]:
    ...
    Args:
        ...
        requires_sandbox: Optional[bool] - If True, the function requires a sandbox to be initialized before execution
