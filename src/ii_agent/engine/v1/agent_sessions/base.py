...
class SessionStore(ABC):
    ...
    async def get_or_create_run_task(
        ...
        *,
        ...
        the run lifecycle. The returned AgentRunTask contains the version
    ...
    async def save_run(self, run: RunOutput) -> None:
        ...
        1. Update the existing AgentRunTask status (with optimistic locking)
        ...
        Args:
            run: The RunOutput to persist. Must have a valid run_id that
                 corresponds to an existing AgentRunTask.
