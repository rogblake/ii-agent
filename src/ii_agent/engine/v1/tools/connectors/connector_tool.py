...
class ConnectorTool(BaseConnectorTool):
    ...
    async def _load_composio_tools(
        ...
        try:
            ...
            from ii_agent.engine.v1.tools.connectors.composio_mcp import load_composio_tools_for_user
    ...
    async def _load_custom_mcp_tools(self) -> List[BaseAgentTool]:
        ...
        try:
            from ii_agent.engine.v1.tools.connectors.custom_mcp import load_custom_mcp_tools_for_user
