...
class SessionTitleService:
    ...
    def __init__(self, config: SessionTitleConfig) -> None:
        self._config = config
    ...
    def _should_generate_semantic_title(self, query: str) -> bool:
        ...
        return bool(
            self._client
            and len(query) >= self._config.semantic_min_query_length
        )
    ...
    async def generate_title(self, query: str, max_length: int = 80) -> str:
