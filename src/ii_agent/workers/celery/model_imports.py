...
MODEL_MODULES: tuple[str, ...] = (
    ...
    "ii_agent.engine.agents.models",
    "ii_agent.engine.sandboxes.models",
    "ii_agent.engine.runtime.db.agent",
    "ii_agent.engine.runtime.db.config",
    "ii_agent.engine.runtime.db.message",
    "ii_agent.engine.runtime.db.summary",
