...
from ii_server.browser.detector import Detector
from ii_server.browser.models import (
    BrowserError,
    BrowserState,
    InteractiveElementsData,
    TabInfo,
)
from ii_server.browser.utils import (
    filter_elements,
    put_highlight_elements_on_screenshot,
    scale_b64_image,
)
from ii_server.browser.utils import is_pdf_url

logger = logging.getLogger(__name__)

INTERACTIVE_ELEMENTS_JS_CODE = resources.read_text(
    "ii_server.browser", "findVisibleInteractiveElements.js"
)
