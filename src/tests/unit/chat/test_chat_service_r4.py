...
class TestIsBinaryFile:
    def test_pdf_is_binary(self):
        from ii_agent.chat.file_processor import is_binary_file
...
class TestIsRemoteUrl:
    def test_http_url(self):
        from ii_agent.chat.file_processor import is_remote_url
...
class TestIsTextExtractable:
    def test_txt_file_extractable(self):
        from ii_agent.chat.file_processor import is_text_extractable
...
class TestContentExtractorFactory:
    ...
    def test_get_extractor_unknown_returns_none(self):
        from ii_agent.chat.file_processor import ContentExtractorFactory
...
class TestTextExtractor:
    def test_extracts_plain_text(self):
        from ii_agent.chat.file_processor import TextExtractor
...
class TestMarkdownExtractor:
    def test_extracts_markdown_content(self):
        from ii_agent.chat.file_processor import MarkdownExtractor
...
class TestCodeExtractor:
    def test_extracts_python_code(self):
        from ii_agent.chat.file_processor import CodeExtractor
...
class TestJSONExtractor:
    def test_pretty_prints_valid_json(self):
        from ii_agent.chat.file_processor import JSONExtractor
...
class TestCSVExtractor:
    def test_extracts_small_csv(self):
        from ii_agent.chat.file_processor import CSVExtractor
...
class TestXMLExtractor:
    def test_extracts_and_formats_xml(self):
        from ii_agent.chat.file_processor import XMLExtractor
...
class TestProcessFilesForMessage:
    ...
    async def test_process_files_structure_has_expected_fields(self):
        from ii_agent.chat.file_processor import ProcessedFiles
...
class TestChatFileProcessor:
    ...
    async def test_process_uploads_with_binary_files_extends_parts(self):
        from ii_agent.chat.file_processing_service import ChatFileProcessor
        from ii_agent.chat.schemas import TextContent, BinaryContent
        ...
        with patch(
            "ii_agent.chat.file_processing_service.process_files_for_message",
    ...
    async def test_process_uploads_with_large_files_calls_vector_store(self):
        ...
        with patch(
            ...
            "ii_agent.chat.file_processing_service.openai_vector_store",
            mock_vs,
        ):
