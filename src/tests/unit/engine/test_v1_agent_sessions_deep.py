"""Deep unit tests for ii_agent.engine.v1.agent_sessions.agent (AgentSession)."""
...
class TestAgentSessionFromDict:
    ...
    def test_deserializes_run_messages_as_list_of_run_outputs(self):
        ...
        with patch("ii_agent.engine.v1.agent_sessions.agent.RunOutput.from_dict") as mock_from_dict:
    ...
    def test_deserializes_summary_from_dict(self):
        ...
        with patch("ii_agent.engine.v1.agent_sessions.agent.SessionSummary.from_dict") as mock_from_dict:
            mock_from_dict.return_value = MagicMock()
            session = AgentSession.from_dict(data)
        assert session is not None
