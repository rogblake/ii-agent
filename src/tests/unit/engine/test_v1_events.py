"""Unit tests for ii_agent.engine.v1.run.events module.
...
from ii_agent.engine.v1.models.message import Citations, Message, MessageReferences, UrlCitation
...
class TestCreateRunOutputContentEvent:
    ...
    def test_references_from_run_output(self, mock_run_output):
        from ii_agent.engine.v1.models.message import MessageReferences
...
class TestHandleEvent:
    ...
    def test_store_events_false_does_not_create_task(self, mock_run_output):
        ...
        event = create_run_started_event(mock_run_output)
        with patch("ii_agent.engine.v1.run.events.asyncio.create_task") as mock_create_task:
...
class TestSessionSummaryEvents:
    def test_create_session_summary_started_event_type(self, mock_run_output):
        from ii_agent.engine.v1.run.events import create_session_summary_started_event
    ...
    def test_create_session_summary_completed_event_type(self, mock_run_output):
        from ii_agent.engine.v1.run.events import create_session_summary_completed_event
