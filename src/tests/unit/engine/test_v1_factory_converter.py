"""Unit tests for ii_agent/engine/v1/factory/converter.py.
...
def _make_run_continued(**kwargs):
    from ii_agent.engine.v1.run.agent import RunContinuedEvent
...
def _make_reasoning_started(**kwargs):
    from ii_agent.engine.v1.run.agent import ReasoningStartedEvent
...
def _make_reasoning_completed(**kwargs):
    from ii_agent.engine.v1.run.agent import ReasoningCompletedEvent
...
def _make_content_delta(**kwargs):
    from ii_agent.engine.v1.run.agent import RunContentDeltaEvent
...
def _make_session_summary_started(**kwargs):
    from ii_agent.engine.v1.run.agent import SessionSummaryStartedEvent
...
def _make_session_summary_completed(**kwargs):
    from ii_agent.engine.v1.run.agent import SessionSummaryCompletedEvent
