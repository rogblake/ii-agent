"""Unit tests for ii_agent.engine.v1.hooks.decorator module.
...
from ii_agent.engine.v1.hooks.decorator import _is_async_function
import ii_agent.engine.v1.hooks.decorator as decorator_module
...
class TestHookDecoratorBare:
    def test_bare_hook_wraps_sync_function(self):
        with _inject_constant():
            from ii_agent.engine.v1.hooks.decorator import hook
...
class TestShouldRunInBackground:
    def test_undecorated_function_returns_false(self):
        with _inject_constant():
            from ii_agent.engine.v1.hooks.decorator import should_run_in_background
    ...
    def test_decorated_with_run_in_background_true_returns_true(self):
        with _inject_constant():
            from ii_agent.engine.v1.hooks.decorator import hook, should_run_in_background
...
class TestHookConstantBug:
    def test_hook_raises_name_error_without_constant_defined(self):
        ...
        """
        import ii_agent.engine.v1.hooks.decorator as dec
