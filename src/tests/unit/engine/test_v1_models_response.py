"""Unit tests for ii_agent/engine/runtime/models/response.py.
...
class TestModelResponseEvent:
    ...
    def test_tool_call_paused_value(self):
        from ii_agent.engine.runtime.models.response import ModelResponseEvent
...
class TestFileType:
    def test_mp4_value(self):
        from ii_agent.engine.runtime.models.response import FileType
...
class TestModelResponse:
    ...
    def test_to_dict_with_tool_executions(self):
        from ii_agent.engine.runtime.models.response import ModelResponse, ToolExecution
    ...
    def test_from_dict_with_tool_executions(self):
        ...
        data = {
            "tool_executions": [
                {"tool_call_id": "c1", "tool_name": "do_something"}
            ],
