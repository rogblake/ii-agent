...
class TestAgentSessionStoreGetHistoryMessages:
    ...
    def _make_run_output(self, status=None, messages=None, model="gpt-4"):
        ...
        from ii_agent.engine.v1.run import RunStatus
        ro = RunOutput(
            run_id=str(uuid4()),
            session_id="sess-1",
            user_id="user-1",
...
class TestReconstructMediaFromDict:
    ...
    def test_reconstruct_image_from_dict_with_url(self):
        from ii_agent.engine.v1.utils.media import reconstruct_image_from_dict
    ...
    def test_reconstruct_video_from_dict_with_url(self):
        from ii_agent.engine.v1.utils.media import reconstruct_video_from_dict
        from ii_agent.engine.v1.media import Video
    ...
    def test_reconstruct_audio_from_dict_with_url(self):
        from ii_agent.engine.v1.utils.media import reconstruct_audio_from_dict
        from ii_agent.engine.v1.media import Audio
    ...
    def test_reconstruct_file_from_dict_with_url(self):
        from ii_agent.engine.v1.utils.media import reconstruct_file_from_dict
        from ii_agent.engine.v1.media import File
...
class TestReconstructMediaLists:
    ...
    def test_reconstruct_images_none_returns_none(self):
        from ii_agent.engine.v1.utils.media import reconstruct_images
    ...
    def test_reconstruct_videos_none_returns_none(self):
        from ii_agent.engine.v1.utils.media import reconstruct_videos
    ...
    def test_reconstruct_audio_list_none_returns_none(self):
        from ii_agent.engine.v1.utils.media import reconstruct_audio_list
    ...
    def test_reconstruct_files_none_returns_none(self):
        from ii_agent.engine.v1.utils.media import reconstruct_files
    ...
    def test_reconstruct_response_audio_none(self):
        from ii_agent.engine.v1.utils.media import reconstruct_response_audio
...
class TestSaveBase64Data:
    ...
    def test_saves_valid_base64_data(self, tmp_path):
        from ii_agent.engine.v1.utils import media as media_module
    ...
    def test_raises_on_invalid_base64(self):
        from ii_agent.engine.v1.utils.media import save_base64_data
...
class TestCopyArgsForBackground:
    ...
    def test_copies_run_input(self):
        from ii_agent.engine.v1.utils.hooks import copy_args_for_background
...
class TestNormalizeHooks:
    ...
    def test_none_hooks_returns_none(self):
        from ii_agent.engine.v1.utils.hooks import normalize_hooks
