...
class TestSkillErrors:
    def test_parse_error_is_skill_error(self):
        from ii_agent.agent.runtime.skills.skills_ref.errors import ParseError, SkillError
...
class TestParseFrontmatter:
    def test_valid_frontmatter_returns_metadata_and_body(self):
        from ii_agent.agent.runtime.skills.skills_ref.parser import parse_frontmatter
    ...
    def test_missing_frontmatter_raises_parse_error(self):
        from ii_agent.agent.runtime.skills.skills_ref.errors import ParseError
        from ii_agent.agent.runtime.skills.skills_ref.parser import parse_frontmatter
...
class TestFindSkillMd:
    def test_returns_path_when_skill_md_exists(self, tmp_path):
        from ii_agent.agent.runtime.skills.skills_ref.parser import find_skill_md
...
class TestBuiltinSkillsDirectory:
    ...
    def test_get_builtin_skill_upath_returns_correct_path(self):
        from ii_agent.agent.runtime.skills.builtin import get_builtin_skill_upath
...
class TestLoadBuiltinSkills:
    def test_returns_non_empty_list(self):
        from ii_agent.agent.runtime.skills.loader import load_builtin_skills
...
class TestGetSkillByName:
    ...
    async def test_returns_enabled_user_skill(self):
        from ii_agent.agent.runtime.skills.loader import get_skill_by_name
