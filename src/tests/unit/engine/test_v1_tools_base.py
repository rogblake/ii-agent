"""Unit tests for ii_agent/engine/runtime/tools/base.py.
...
class TestUserInputField:
    ...
    def test_roundtrip_to_dict_and_from_dict(self):
        ...
        original = UserInputField(name="email", field_type=str, description="Email address", value="a@b.com")
...
class TestToolParam:
    ...
    def test_create_minimal_function_param(self):
        from ii_agent.engine.runtime.tools.base import ToolParam
...
class TestToolResult:
    ...
    def test_requires_user_input_can_be_set_true(self):
        from ii_agent.engine.runtime.tools.base import ToolResult, UserInputField
...
class TestToolConfirmationDetails:
    ...
    def test_create_with_edit_type(self):
        from ii_agent.engine.runtime.tools.base import ToolConfirmationDetails
...
class TestFileURLContent:
    ...
    def test_create_valid_file_url_content(self):
        from ii_agent.engine.runtime.tools.base import FileURLContent
