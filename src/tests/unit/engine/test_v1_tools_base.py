...
class TestToolParam:
    ...
    def test_create_minimal_function_param(self):
        from ii_agent.agent.runtime.tools.base import ToolParam
...
class TestToolResult:
    ...
    def test_requires_user_input_can_be_set_true(self):
        from ii_agent.agent.runtime.tools.base import ToolResult, UserInputField
...
class TestToolConfirmationDetails:
    ...
    def test_create_with_edit_type(self):
        from ii_agent.agent.runtime.tools.base import ToolConfirmationDetails
...
class TestFileURLContent:
    ...
    def test_create_valid_file_url_content(self):
        from ii_agent.agent.runtime.tools.base import FileURLContent
