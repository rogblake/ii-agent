...
class TestComposioMCPTool:
    ...
    def _make_composio_tool(self):
        from ii_agent.engine.v1.tools.mcp.composio_mcp import ComposioMCPTool
...
class TestMCPToolLoader:
    ...
    async def test_loads_tools_from_mcp_server(self):
        from ii_agent.engine.v1.tools.mcp.mcp_tool_loader import load_tools_from_mcp
        ...
        with patch("ii_agent.engine.v1.tools.mcp.mcp_tool_loader.Client", return_value=mock_client):
