"""Unit tests for engine/v1/tools/function.py - r4.
...
class TestGetEntrypointDocstring:
    ...
    def test_simple_function_returns_short_desc(self):
        from ii_agent.engine.v1.tools.function import get_entrypoint_docstring
...
class TestFunctionExecutionResult:
    ...
    def test_success_result(self):
        from ii_agent.engine.v1.tools.function import FunctionExecutionResult
