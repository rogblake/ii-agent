...
_mod_stub(
    "ii_agent.agents.agent_controller",
...
_pkg_stub("ii_agent.agents.models")
_pkg_stub("ii_agent.agents.models.google")
_mod_stub(
    "ii_agent.agents.models.google.interactions",
...
_factory_pkg = _pkg_stub("ii_agent.agents.legacy")
_factory_pkg.AgentFactory = type("AgentFactory", (), {})
_mod_stub(
    "ii_agent.agents.legacy.factory",
    AgentFactory=type("AgentFactory", (), {}),
)
_mod_stub(
    "ii_agent.agents.legacy.converter",
